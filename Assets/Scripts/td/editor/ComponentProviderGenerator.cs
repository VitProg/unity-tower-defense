...
namespace td.editor
{
    ...
    public class ComponentProviderGenerator : ScriptableObject
    {
        ...
        public static void Generate()
        {
            ...
            if (!AssetDatabase.IsValidFolder("Assets/Scripts/Generated/ComponentProviders"))
            {
                AssetDatabase.CreateFolder("Assets/Scripts/Generated", "ComponentProviders");
            }

            var folderPath = "Assets/Scripts/Generated/ComponentProviders";
