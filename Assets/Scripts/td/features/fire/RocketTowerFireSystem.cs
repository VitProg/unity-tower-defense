        ...
        public void Run(IEcsSystems systems)
        {
            ...
            foreach (var entity in entities.Value)
            {
                ...
                if (target.TargetEntity.Unpack(world, out var targetEntity))
                {
                    ...
                    EntityUtils.GetComponent<IsProjectile>(systems, projectileEntity).damage = rocket.damage;
                    EntityUtils.GetComponent<MoveToTarget>(systems, projectileEntity).speed = rocket.maxEnergy;
                    ...
                    EntityUtils.AddComponent(systems, projectileEntity, new InertiaOfMovement()
                    {
