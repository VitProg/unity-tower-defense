...
{
    public class DefaultMovementSystem : ProtoIntervalableRunSystem, IProtoPreInitSystem
    {
        ...
        public DefaultMovementSystem(float interval, float timeShift, Func<float> getDeltaTime) : base(interval, timeShift,
            getDeltaTime)
        {
        }
    }
