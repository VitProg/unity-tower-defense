...
namespace td.features.projectile.lightning
{
     ...
     */
    public class LightningLineCorrectionSystem : EcsIntervalableRunSystem
    {
        private readonly EcsWorldInject world;
        private readonly EcsInject<Common_Service> common;
        private readonly EcsInject<Enemy_Service> enemyService;
        
        private readonly EcsFilterInject<Inc<LightningLine, Ref<GameObject>>, ExcludeNotAlive> entities = default; 
        ...
        public LightningLineCorrectionSystem(float interval, float timeShift, Func<float> getDeltaTime) : base(interval, timeShift, getDeltaTime)
        {
        }
    }
}