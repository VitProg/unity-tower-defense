...
namespace td.features.enemies
{
    ...
    public class EnemiesConfig : ScriptableObject
    {
        ...
        public AnimatorController creepSmallAnimatorController;
        ...
        public AnimatorController creepMiddleAnimatorController;
        ...
        public AnimatorController creepLargeAnimatorController;

        public AnimatorController GetAnimatorController(CreepEnemyTypes type)
        {
            return type switch
            {
