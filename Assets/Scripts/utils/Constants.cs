...
namespace td.utils
{
    public static class Constants
    {
        ...
        {
            public const int MaxMapArrayWidth = 64;
            public const int MaxMapArrayHeight = 64;
            public const int MaxRect = 99;
            public const int MinRect = -99;
            public const int MaxSpawns = 10;
            public const int MaxKernels = 5;
        }
        ...
        public static class UI
        {
            ...
            public static class Shard
            {
                ...
                public const float ColorAnimSpeed = 32f;
                public const byte DefaultInCollection = 6;
                public const byte MinInCollection = 2;
                public const byte MaxInCollection = 12;
                public const int MaxCachedColors = 32;
            }
        }
        ...
        public static class Prjoctiles
        {
        ...
        {
            public const string ShardTower = "shard_tower";
            public const string ShardTrap = "shard_trap";
