...
//             cellType == LevelCellType.Hex ? HexGridUtils.PositionToCell(position, cellSize) : SquareGridUtils.CoordsToCell(position, cellSize);
//
//         public static Vector2 CellToCoords(Int2 coordinate, LevelCellType cellType, float cellSize) =>
//             cellType == LevelCellType.Hex ? HexGridUtils.CellToPosition(coordinate, cellSize) : SquareGridUtils.CellToCoords(coordinate, cellSize);
//
