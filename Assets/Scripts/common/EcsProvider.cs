...
//     public abstract class EcsProvider<TComponent> : BaseEcsProvider, IUnConvertableEntity where TComponent : struct
//     {
...
//         }
//
//         public void UnConvert(int e, EcsWorld w)
//         {
//             var pool = w.GetPool<TComponent>();
//
//             if (pool.Has(e)) pool.Del(e);
...
//     }
//
//     public interface IUnConvertableEntity
//     {
//         public void UnConvert(int e, EcsWorld w);
//     }
// }