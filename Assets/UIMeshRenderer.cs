...
namespace td
{
    ...
    {
        [OnValueChanged("Refresh")][SerializeField] Material Material;
        [OnValueChanged("Refresh")][SerializeField] private Mesh mesh;
        [OnValueChanged("Refresh")][SerializeField] bool mask;
        ...
        void OnEnable()
        {
            // Debug.Log("UIMethRenderer : OnEnable");
            // Refresh();
            if (canvasRenderer)
            {
