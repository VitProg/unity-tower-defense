Shader "Custom/HexagonHighlight" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            {    
                ...
                // the two sets are stored in a "float4" in order to group some calculations together. The hexagon
            ...
            float4 frag(v2f_customrendertexture IN) : COLOR
            {
                ...
                float2 u = (IN.vertex - _ScreenParams.xy * 0.5) / _ScreenParams.y;
                ...
                float4 h = getHex(u * 5.0 + s.yx * _Time.y * 0.5);
                ...
                float3 col = lerp(float3(1.0, 1.0, 1.0), float3(0.0, 0.0, 0.0), smoothstep(0.0, 0.03, eDist - 0.5 + 0.04));  
                return float4(1, 0, 0, 0);
