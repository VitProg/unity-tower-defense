...
float4 DoDebug_float(float val, float2 uv, int decimalDigits, out float4 res)
{
...
// float4 DoDebug(float val, float2 uv, int decimalDigits)
// {
    // float4 res = float4(0.3,0.2,0.1,1);
    // res = PrintValue(uv*200, float2(10,100), float2(8,15), val, 10, decimalDigits);
    // return res;
// }